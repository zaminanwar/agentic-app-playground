# =============================================================================
# outputs.tf (prod) — re-export the module outputs CD and operators need.
# =============================================================================
...
output "agent_image" {
  description = "Resolved agent image reference deployed to prod."
  value       = module.app.agent_image
}

output "web_image" {
  description = "Resolved web image reference deployed to prod."
